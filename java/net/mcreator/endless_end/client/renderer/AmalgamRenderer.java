...
public class AmalgamRenderer extends GeoEntityRenderer<AmalgamEntity> {
	public AmalgamRenderer(EntityRendererProvider.Context renderManager) {
		super(renderManager, new AmalgamModel());
	...
	@Override
	protected float getDeathMaxRotation(AmalgamEntity entityLivingBaseIn) {
		return 0.0F;
	}
}
