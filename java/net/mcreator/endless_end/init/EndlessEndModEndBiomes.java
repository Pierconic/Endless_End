...
public class EndlessEndModEndBiomes {
	...
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> {
			TheEndBiomes.addHighlandsBiome(ResourceKey.create(Registries.BIOME, ResourceLocation.parse("endless_end:chorus_orchard")), 1.2d);
			TheEndBiomes.addMidlandsBiome(ResourceKey.create(Registries.BIOME, ResourceLocation.parse("endless_end:chorus_orchard")), ResourceKey.create(Registries.BIOME, ResourceLocation.parse("endless_end:chorus_orchard")), 1d);
			TheEndBiomes.addBarrensBiome(ResourceKey.create(Registries.BIOME, ResourceLocation.parse("endless_end:chorus_orchard")), ResourceKey.create(Registries.BIOME, ResourceLocation.parse("endless_end:chorus_orchard")), 1.2d);
			...
			TheEndBiomes.addMidlandsBiome(ResourceKey.create(Registries.BIOME, ResourceLocation.parse("endless_end:inverted_orchard")), ResourceKey.create(Registries.BIOME, ResourceLocation.parse("endless_end:inverted_orchard")), 1d);
			TheEndBiomes.addBarrensBiome(ResourceKey.create(Registries.BIOME, ResourceLocation.parse("endless_end:inverted_orchard")), ResourceKey.create(Registries.BIOME, ResourceLocation.parse("endless_end:inverted_orchard")), 1d);
