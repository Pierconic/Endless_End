...
public class EndlessEndModSounds {
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> TRAWLER_ATTACK = REGISTRY.register("trawler_attack", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "trawler_attack")));
	public static final DeferredHolder<SoundEvent, SoundEvent> TRAWLER_WARP = REGISTRY.register("trawler_warp", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "trawler_warp")));
	public static final DeferredHolder<SoundEvent, SoundEvent> GRAZER_HURT = REGISTRY.register("grazer_hurt", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "grazer_hurt")));
	public static final DeferredHolder<SoundEvent, SoundEvent> GRAZER_DEATH = REGISTRY.register("grazer_death", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "grazer_death")));
	public static final DeferredHolder<SoundEvent, SoundEvent> TRAWLER_HURT = REGISTRY.register("trawler_hurt", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "trawler_hurt")));
	public static final DeferredHolder<SoundEvent, SoundEvent> TRAWLER_DEATH = REGISTRY.register("trawler_death", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "trawler_death")));
	public static final DeferredHolder<SoundEvent, SoundEvent> CHORUS_DISC = REGISTRY.register("chorus_disc", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "chorus_disc")));
	public static final DeferredHolder<SoundEvent, SoundEvent> ENDERPORTER_LOOP = REGISTRY.register("enderporter.loop", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "enderporter.loop")));
	public static final DeferredHolder<SoundEvent, SoundEvent> BLAST_BERRY_SMALL = REGISTRY.register("blast_berry.small", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "blast_berry.small")));
	public static final DeferredHolder<SoundEvent, SoundEvent> BLAST_BERRY_MEDIUM = REGISTRY.register("blast_berry.medium", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "blast_berry.medium")));
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> LEAD_COPPER_0 = REGISTRY.register("lead_copper_0", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "lead_copper_0")));
	public static final DeferredHolder<SoundEvent, SoundEvent> LEAD_COPPER_1 = REGISTRY.register("lead_copper_1", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "lead_copper_1")));
	public static final DeferredHolder<SoundEvent, SoundEvent> LEAD_COPPER_2 = REGISTRY.register("lead_copper_2", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "lead_copper_2")));
	public static final DeferredHolder<SoundEvent, SoundEvent> LEAD_COPPER_3 = REGISTRY.register("lead_copper_3", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "lead_copper_3")));
	public static final DeferredHolder<SoundEvent, SoundEvent> LEAD_COPPER_4 = REGISTRY.register("lead_copper_4", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "lead_copper_4")));
	public static final DeferredHolder<SoundEvent, SoundEvent> LEAD_COPPER_5 = REGISTRY.register("lead_copper_5", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "lead_copper_5")));
	public static final DeferredHolder<SoundEvent, SoundEvent> LEAD_COPPER_6 = REGISTRY.register("lead_copper_6", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "lead_copper_6")));
	public static final DeferredHolder<SoundEvent, SoundEvent> LEAD_COPPER_7 = REGISTRY.register("lead_copper_7", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "lead_copper_7")));
	public static final DeferredHolder<SoundEvent, SoundEvent> LEAD_COPPER_8 = REGISTRY.register("lead_copper_8", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "lead_copper_8")));
	public static final DeferredHolder<SoundEvent, SoundEvent> LEAD_COPPER_9 = REGISTRY.register("lead_copper_9", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "lead_copper_9")));
	public static final DeferredHolder<SoundEvent, SoundEvent> LEAD_COPPER_10 = REGISTRY.register("lead_copper_10", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "lead_copper_10")));
	public static final DeferredHolder<SoundEvent, SoundEvent> LEAD_COPPER_11 = REGISTRY.register("lead_copper_11", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "lead_copper_11")));
	public static final DeferredHolder<SoundEvent, SoundEvent> LEAD_COPPER_12 = REGISTRY.register("lead_copper_12", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "lead_copper_12")));
	public static final DeferredHolder<SoundEvent, SoundEvent> COPPER_LOOP_0 = REGISTRY.register("copper_loop_0", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "copper_loop_0")));
	public static final DeferredHolder<SoundEvent, SoundEvent> COPPER_LOOP_1 = REGISTRY.register("copper_loop_1", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "copper_loop_1")));
	public static final DeferredHolder<SoundEvent, SoundEvent> COPPER_LOOP_2 = REGISTRY.register("copper_loop_2", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "copper_loop_2")));
	public static final DeferredHolder<SoundEvent, SoundEvent> COPPER_LOOP_3 = REGISTRY.register("copper_loop_3", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "copper_loop_3")));
	public static final DeferredHolder<SoundEvent, SoundEvent> COPPER_LOOP_4 = REGISTRY.register("copper_loop_4", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "copper_loop_4")));
	public static final DeferredHolder<SoundEvent, SoundEvent> COPPER_LOOP_5 = REGISTRY.register("copper_loop_5", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "copper_loop_5")));
	public static final DeferredHolder<SoundEvent, SoundEvent> COPPER_LOOP_6 = REGISTRY.register("copper_loop_6", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "copper_loop_6")));
	public static final DeferredHolder<SoundEvent, SoundEvent> COPPER_LOOP_7 = REGISTRY.register("copper_loop_7", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "copper_loop_7")));
	public static final DeferredHolder<SoundEvent, SoundEvent> COPPER_LOOP_8 = REGISTRY.register("copper_loop_8", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "copper_loop_8")));
	public static final DeferredHolder<SoundEvent, SoundEvent> COPPER_LOOP_9 = REGISTRY.register("copper_loop_9", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "copper_loop_9")));
	public static final DeferredHolder<SoundEvent, SoundEvent> COPPER_LOOP_10 = REGISTRY.register("copper_loop_10", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "copper_loop_10")));
	public static final DeferredHolder<SoundEvent, SoundEvent> COPPER_LOOP_11 = REGISTRY.register("copper_loop_11", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "copper_loop_11")));
	public static final DeferredHolder<SoundEvent, SoundEvent> COPPER_LOOP_12 = REGISTRY.register("copper_loop_12", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "copper_loop_12")));
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> AMALGAM_LOOP = REGISTRY.register("amalgam.loop", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "amalgam.loop")));
	public static final DeferredHolder<SoundEvent, SoundEvent> BREEZE_SPELL_CHARGE = REGISTRY.register("breeze_spell.charge", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "breeze_spell.charge")));
	public static final DeferredHolder<SoundEvent, SoundEvent> BREEZE_SPELL_TRIGGER = REGISTRY.register("breeze_spell.trigger", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "breeze_spell.trigger")));
	public static final DeferredHolder<SoundEvent, SoundEvent> AMALGAM_SPAWN = REGISTRY.register("amalgam.spawn", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "amalgam.spawn")));
	public static final DeferredHolder<SoundEvent, SoundEvent> FLURRY_SPELL = REGISTRY.register("flurry_spell", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "flurry_spell")));
	public static final DeferredHolder<SoundEvent, SoundEvent> SAGE_DEFLECT = REGISTRY.register("sage.deflect", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "sage.deflect")));
	public static final DeferredHolder<SoundEvent, SoundEvent> SAGE_HURT = REGISTRY.register("sage.hurt", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "sage.hurt")));
	public static final DeferredHolder<SoundEvent, SoundEvent> SAGE_DEATH = REGISTRY.register("sage.death", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("endless_end", "sage.death")));
}
