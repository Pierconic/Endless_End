...
import net.mcreator.endless_end.procedures.MembranePushProcedure;
...
public class EndoriteMembraneBlock extends Block {
	...
	public EndoriteMembraneBlock() {
		super(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM).mapColor(MapColor.COLOR_CYAN)
				...
				.strength(20f).requiresCorrectToolForDrops().noCollission().noOcclusion().isRedstoneConductor((bs, br, bp) -> false));
	...
	public void entityInside(BlockState blockstate, Level world, BlockPos pos, Entity entity) {
		...
		MembranePushProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate, entity);
	}
}
