...
public class BlossomingGoldenSepalLeavesBlock extends Block implements SimpleWaterloggedBlock {
	...
	public BlossomingGoldenSepalLeavesBlock() {
		super(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.WARPED_STEM).sound(SoundType.GRASS).strength(2f, 0.08f).lightLevel(s -> (new Object() {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		BlastBerryGrowthProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), blockstate);
	}
