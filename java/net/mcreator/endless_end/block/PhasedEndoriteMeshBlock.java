...
import net.mcreator.endless_end.procedures.EndoriteRegenerateProcedure;
...
public class PhasedEndoriteMeshBlock extends Block implements SimpleWaterloggedBlock {
	...
	public PhasedEndoriteMeshBlock() {
		super(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM).mapColor(MapColor.COLOR_CYAN)
				...
				.strength(10f).requiresCorrectToolForDrops().noCollission().noOcclusion().isRedstoneConductor((bs, br, bp) -> false));
