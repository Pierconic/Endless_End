...
public class EnderporterRedTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public EnderporterRedTileEntity(BlockPos pos, BlockState state) {
		super(EndlessEndModBlockEntities.ENDERPORTER_RED.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(EnderporterRedBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<EnderporterRedTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<EnderporterRedTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("enderporter_red");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Red Enderporter");
	}
