...
public class PuffBlossomTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public PuffBlossomTileEntity(BlockPos pos, BlockState state) {
		super(EndlessEndModBlockEntities.PUFF_BLOSSOM.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(PuffBlossomBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<PuffBlossomTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<PuffBlossomTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("puff_blossom");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Puff Blossom");
	}
