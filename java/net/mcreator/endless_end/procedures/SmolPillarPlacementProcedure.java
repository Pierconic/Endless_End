	...
	public static void execute(LevelAccessor world, double x, double z, double type) {
		...
		for (int index0 = 0; index0 < Mth.nextInt(RandomSource.create(), 4, 6); index0++) {
			...
			if (rando == 1) {
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("endless_end", "small_pillar_segment_3"));
					if (template != null) {
						template.placeInWorld(_serverworld, BlockPos.containing(x, sy, z), BlockPos.containing(x, sy, z), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random,
								3);
					}
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("endless_end", "small_pillar_segment_4"));
					if (template != null) {
						template.placeInWorld(_serverworld, BlockPos.containing(x, sy, z), BlockPos.containing(x, sy, z), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random,
								3);
					}
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("endless_end", "small_pillar_segment_5"));
					if (template != null) {
						template.placeInWorld(_serverworld, BlockPos.containing(x, sy, z), BlockPos.containing(x, sy, z), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random,
								3);
					}
				...
				if (world instanceof ServerLevel _serverworld) {
					StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("endless_end", "small_pillar_segment_6"));
					if (template != null) {
						template.placeInWorld(_serverworld, BlockPos.containing(x, sy, z), BlockPos.containing(x, sy, z), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random,
								3);
					}
		...
		if (type == 2) {
			if (world instanceof ServerLevel _serverworld) {
				StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("endless_end", "small_pillar_topper_3"));
				if (template != null) {
			...
			if (world instanceof ServerLevel _serverworld) {
				StructureTemplate template = _serverworld.getStructureManager().getOrCreate(ResourceLocation.fromNamespaceAndPath("endless_end", "small_pillar_topper_2"));
				if (template != null) {
					template.placeInWorld(_serverworld, BlockPos.containing(x, sy, z), BlockPos.containing(x, sy, z), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
				}
			}
