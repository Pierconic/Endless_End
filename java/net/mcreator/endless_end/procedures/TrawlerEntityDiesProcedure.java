...
public class TrawlerEntityDiesProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity sourceentity) {
		...
		for (int index0 = 0; index0 < Mth.nextInt(RandomSource.create(), 2, (int) (6 + modifier)); index0++) {
		...
		for (int index1 = 0; index1 < Mth.nextInt(RandomSource.create(), 1, (int) (3 + modifier)); index1++) {
			if (world instanceof ServerLevel _level) {
