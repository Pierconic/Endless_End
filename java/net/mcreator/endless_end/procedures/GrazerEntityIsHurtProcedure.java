...
public class GrazerEntityIsHurtProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if (sourceentity instanceof LivingEntity _livEnt5 && _livEnt5.hasEffect(EndlessEndModMobEffects.FRAGRANCE)) {
		...
		if (!(sourceentity instanceof Player _plr ? _plr.getAbilities().instabuild : false) && !(entity instanceof LivingEntity _livEnt19 && _livEnt19.hasEffect(MobEffects.MOVEMENT_SPEED))
				&& !(entity instanceof LivingEntity _livEnt20 && _livEnt20.hasEffect(MobEffects.LUCK))) {
			if (entity instanceof GrazerEntity) {
				((GrazerEntity) entity).setAnimation("warp");
			}
			if (!(entity instanceof LivingEntity _livEnt22 && _livEnt22.hasEffect(MobEffects.UNLUCK))) {
