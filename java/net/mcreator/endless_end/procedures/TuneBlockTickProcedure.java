		...
		if ((blockstate.getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip1 ? blockstate.getValue(_getip1) : -1) > 12) {
				...
				if (new Object() {
					...
					if (!world.isClientSide()) {
						...
						if (_blockEntity != null)
							_blockEntity.getPersistentData().putDouble("Duration", 19);
			...
			if (Math.random() < 0.5) {
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.POOF, ((x + 0.5) - sx + Mth.nextDouble(RandomSource.create(), -0.1, 0.1)), ((y + 0.5) - sy + Mth.nextDouble(RandomSource.create(), -0.1, 0.1)),
							((z + 0.5) - sz + Mth.nextDouble(RandomSource.create(), -0.1, 0.1)), 1, 0.07, 0.07, 0.07, 0.05);
			}
		} else {
			if (!world.isClientSide()) {
				BlockPos _bp = BlockPos.containing(x, y, z);
