...
public class TrebleTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		if ((blockstate.getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip1 ? blockstate.getValue(_getip1) : -1) == 0) {
			if ((new Object() {
			...
			}.getValue(world, BlockPos.containing(x, y, z), "age") >= 10 || Math.random() < 0.3) && 1 < new Object() {
				public double getValue(LevelAccessor world, BlockPos pos, String tag) {
					BlockEntity blockEntity = world.getBlockEntity(pos);
					if (blockEntity != null)
						return blockEntity.getPersistentData().getDouble(tag);
				...
				world.setBlock(BlockPos.containing(x, y + 1, z), EndlessEndModBlocks.TREBLE_BLOOM.get().defaultBlockState(), 3);
				...
				|| (blockstate.getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip13 ? blockstate.getValue(_getip13) : -1) == 2) {
			{
