...
public class FlurryEntity extends Monster implements RangedAttackMob, GeoEntity {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "flurry_blank");
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, Blaze.class, false, false));
		...
		this.goalSelector.addGoal(1, new FlurryEntity.RangedAttackGoal(this, 1.25, 20, 24f) {
			@Override
	...
	public class RangedAttackGoal extends Goal {
		...
		public void stop() {
			...
			this.seeTime = 0;
			this.attackTime = -1;
			((FlurryEntity) rangedAttackMob).entityData.set(SHOOT, false);
		}
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((FlurryEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	public void baseTick() {
		super.baseTick();
		FlurryTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		FlurryChargeBlastEntity.shoot(this, target);
	}
