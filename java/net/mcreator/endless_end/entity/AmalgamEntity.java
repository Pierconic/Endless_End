...
public class AmalgamEntity extends Monster implements GeoEntity {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AmalgamEntity.class, EntityDataSerializers.STRING);
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("endless_end:amalgam.ambient"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("endless_end:amalgam.hit"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("endless_end:amalgam.death"));
	}
	...
	public void baseTick() {
		super.baseTick();
		AmalgamTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 35) {
			this.remove(AmalgamEntity.RemovalReason.KILLED);
			this.dropExperience(this);
			AmalgamImplosionProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
		}
	}
